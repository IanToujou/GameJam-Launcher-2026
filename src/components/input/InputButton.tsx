    ...
    if (props.icon) {
        return (
            <div
                ...
                className="bg-neutral-dark border-neutral-light ring-primary-medium flex size-18 cursor-pointer items-center justify-center rounded-full border-6 ring-0 duration-200 hover:ring-6"
            >
