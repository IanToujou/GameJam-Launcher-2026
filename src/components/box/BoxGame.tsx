...
const BoxGame = (props: BoxGameProps) => {
    return (
        <div
            ...
            className="bg-neutral-dark border-neutral-light ring-primary-medium group flex cursor-pointer flex-col rounded-4xl border-8 p-5 ring-0 transition-all duration-200 hover:ring-8"
        >
